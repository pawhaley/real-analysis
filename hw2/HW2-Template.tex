...
I will start by choosing a arbitrary set $a,b\in\mathbb{R}$ where $a<b$.  Next let $c=a+\frac{1}{3}(b-a)$ and $d=a+\frac{2}{3}(b-a)$.  Note that $a<c<d<b$ so $[c,d]\subseteq (a,b)$.  Now consider two cases, ether $c,d\in\mathbb{Q}$ or one or more of them is irrational.  In the case that one or more of them is irrational then it would be a irrational in $(a,b)$ and we're done.  So now we only need to consider the case where $c,d\in\mathbb{Q}$.  In this case consider $t=c+\frac{\sqrt{2}}{2}(d-c)$.  Noting that $(d-c)\neq 0$ we conclude $\frac{\sqrt{2}}{2}(d-c)\in \mathbb{I}$ and thus $c+\frac{\sqrt{2}}{2}(d-c)\in \mathbb{I}$ also note that $0<\frac{\sqrt{2}}{2}<1$ so $c<c+\frac{\sqrt{2}}{2}(d-c)<d$ therefore $c+\frac{\sqrt{2}}{2}(d-c)\in (a,b)$ and we have found a irrational in $(a,b)$.
\end{proof}
...
$$g(x)=\begin{cases}
0 & x=1/2\\
(1/2)^{n-1} & x=(1/2)^n $ for some $ n\in \mathbb{N}-\{1\}\\
x & $otherwise$
\end{cases}
$$
