...
Choose $\epsilon>0$.  By the definition of limit of a sequence we know that there exists a $N_1$ such that for all $n\geq N_1$, $|x_n-l|<\epsilon$.  By the definition of limit of a sequence we know that there exists a $N_2$ such that for all $n\geq N_2$, $|y_n-l|<\epsilon$.  Define $N=2*(\max(N_1,N_2))$.  Choose $n\geq N$.  There are two possibilities, eater $n\in$ odd or $n\notin$ odd.\\
...
let $l=\lim z_n$.\\
Choose $\epsilon>0$.  By the definition of limit of a sequence we know that there exists a $N$ such that for all $m\geq N$, $|z_m-l|<\epsilon$.  Choose a $n\geq N$.  let $m=2n-1$.  Note that $m\geq n\geq N$ and that $m\in$ odds, so $z_m=x_{(m+1)/2}=x_n$.  Since $m\geq N$, $|x_n-l|=|z_m-l|<\epsilon$.  Thus $x_n$ converges to $l$.\\
Choose $\epsilon>0$.  By the definition of limit of a sequence we know that there exists a $N$ such that for all $m\geq N$, $|z_m-l|<\epsilon$.  Choose a $n\geq N$.  let $m=2n$.  Note that $m> n\geq N$ and that $m\notin$ odds, so $z_m=y_{m/2}=y_n$.  Since $m\geq N$, $|y_n-l|=|z_m-l|<\epsilon$.  Thus $y_n$ converges to $l$.\\
